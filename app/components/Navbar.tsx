        ...
        <div>
           <div className='flex items-center justify-between py-4 relative'>
            <div className='flex items-center md:space-x-10 lg:space-x-20'>
                    <div className='font-semibold text-2xl'><a href="/">AKASHA</a></div>
                ...
                <div className='flex items-center space-x-4'>
                   ...
                   <div onClick={() => setShowProfile(!showProfile)} className='relative cursor-pointer'>
                    ...
                    <img src='images/user.jpg' className='w-10 h-10 rounded-full object-cover' alt="" />
                   ...
                   <Link href='/cart'>
                    ...
                    <span onClick={() => setShowNav(!showNav)} className='p-2 bg-gray-100 rounded-full md:hidden'>
                    <BsChevronCompactUp className={`transition ease-in duration-150 ${showNav ? "transform rotate-180" : "transform rotate-0"}`} />
                    </span>
                </div>
            </div>
